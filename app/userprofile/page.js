    ...
    return (
        <MainLayout>
            <Box pt={2} display='flex' justifyContent='center'>
                <Container maxWidth="lg">
                    <Paper elevation={3} sx={{ borderRadius: '15px', mx: 'auto', width: { xs: '100%', sm: '80%', md: '60%' }, px: { xs: 2, sm: 4 }, py: 4 }} >
                        <Stack spacing={2}>
                            <Typography variant='h5' color='text.hint' fontWeight='600' textAlign="center">User Profile</Typography>

                            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
                                <Typography variant="body2" fontWeight='600' color='text.hint' fontSize='14px' sx={{ width: { sm: '32%' } }}>Name:</Typography>
                                <Typography variant='body2' color='text.secondary' fontSize='14px'>
                                    {capitalizeFirstLetter(`${user.first_name} ${user.last_name}`)}
                                </Typography>
                            </Stack>
                            ...
                            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
                                <Typography variant="body2" fontWeight='600' color='text.hint' fontSize='14px' sx={{ width: { sm: '32%' } }}>Company:</Typography>
                                <Typography variant='body2' color='text.secondary' fontSize='14px'>
                                    {capitalizeFirstLetter(user.currentCompanyName)}
                                </Typography>
                            </Stack>
                            ...
                            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1}>
                                <Typography variant="body2" fontWeight='600' color='text.hint' fontSize='14px' sx={{ width: { sm: '32%' } }}>UPI ID:</Typography>
                                <Typography variant='body2' color='text.secondary' fontSize='14px'>{user.upi_id}</Typography>
                            </Stack>
                        ...
                        <Stack mt={4} spacing={2}>
                            <Typography variant='h5' color='text.hint' fontWeight='600' textAlign="center">Edit Details</Typography>
                            <Stack>
                                <InputLabel htmlFor="Current" sx={{ fontWeight: '600', color: 'text.hint' }}>Current Company:</InputLabel>
                                <OutlinedInput
                                    size="small"
