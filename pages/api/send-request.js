...
export default async function handler(req, res) {
    if (req.method === 'POST') {
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6;">
           ...
           <p>
              <a href="/requests-received" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Accept</a>
              <a href="/requests-received" style="background-color: #f44336; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Reject</a>
            </p>
